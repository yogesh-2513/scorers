    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    <form method="post" enctype="multipart/form-data" id="edit_achievement">
                    <?php
                        foreach ($edit_achievement as $value):
                    ?>
...
<script>
$("#edit_achievement").on('submit',function(event){
    event.preventDefault();
    var formdata=new FormData(this);
    $.ajax({
        url:'<?php echo site_url()."admin/achievement/do_edit_achievement_content" ?>',
        type:"POST",
        data:formdata,
        processData:false,
        contentType:false,
        ...
        success:function(response){
            ...
            if(temp['error'] == 0){
                $("#edit_achievement").trigger('reset');
