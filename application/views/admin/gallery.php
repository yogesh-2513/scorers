<div class="content-page">
    <div class="content">
        <div class="container">
            ...
            <!-- gallery Image Upload Form Container Starts -->
            ...
            <!-- gallery Image Upload Form Container Ends -->



            <!-- gallery Image List Table Container Starts -->
                    ...
                    <table class="table table-light" id='table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <img src="<?php echo base_url().$value->image ?>" alt="scorers gallery image" height="192" width="192">
            ...
            <!-- gallery Image List Table Container Ends -->
...
$("#upload_image").on('submit',function(event){
    ...
    $.ajax({
        url:"<?php echo site_url()."admin/gallery/gallery_add" ?>",
        type:"POST",
        processData:false,
        contentType:false,
        data:formData,
        ...
        success:function(response)
        {
            ...
            if(temp['error'] == 0){
                ...
                $("#table_container").load('<?php echo site_url()."admin/gallery/" ?>  #table');
            }else{
...
function change_status(id,status){
    ...
    $.ajax({
        url:"<?php echo site_url()."admin/gallery/gallery_status" ?>",
        type:"POST",
        processData:false,
        contentType:false,
        data:formdata,
...
function delete_image(id,path){
    ...
    $.ajax({
        url:"<?php echo site_url()."admin/gallery/gallery_delete" ?>",
        type:"POST",
        processData:false,
        contentType:false,
        data:formdata,
