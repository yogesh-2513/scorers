    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-10">
                    <form method="post" id="form_add_service_category">
...
<script>
$("#form_add_service_category").on('submit',function(e){
    e.preventDefault();
    var formdata=new FormData(this);
    $.ajax({
        url:"<?php echo site_url()."admin/service/add_category" ?>",
        type:"POST",
        data:formdata,
        contentType:false,
        processData:false,
        ...
        success:function(response){
            ...
            console.log(temp);
            if(temp['error'] == 0){
                $("#form_add_service_category").trigger('reset');
