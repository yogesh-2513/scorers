    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Edit Promotion Content</h4>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-10">
                    <form method="post" id="form_promotion_edit_content" enctype='multipart/form-data'>
                        <?php
                            foreach ($edit_promotion_content as $value):
                        ?>
                        <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                        <input type="hidden" name="old_image" value="<?php echo $value->image; ?>">
                        <div class="form-group">
                            <label for="promotion">Promotion</label>
                            <select name="promotion" class="form-control" id="pro_id" required>
                        ...
                        <script>
                            $("#pro_id").val('<?php echo $value->pro_id; ?>');
                        </script>
                        <?php
                            endforeach;
                        ?>
...
<script>
$("#form_promotion_edit_content").on('submit',function(event){
    event.preventDefault();
    var formdata=new FormData(this);
    $.ajax({
        url:"<?php echo site_url()."admin/promotion/do_edit_promotion_content" ?>",
        type:"POST",
        data:formdata,
        contentType:false,
        processData:false,
        ...
        success:function(response){
            ...
            console.log(temp);
            if(temp['error'] == 0){
                $("#form_promotion_edit_content").trigger('reset');
