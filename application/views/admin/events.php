    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-10">
                    <form method="post" enctype="multipart/form-data" id="form_add_event">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name='date' class="form-control" id='date' placeholder="YYYY/MM/DD" required>
                        </div>
                        <div class="form-group">
                            <label for="time">Time</label>
                            <input type="text" name='time' class="form-control" id='time' placeholder="HH:MM:SS" required>
                        </div>
                        <div class="form-group">
...
$("#form_add_event").on('submit',function(e){
    ...
    $.ajax({
        url:"<?php echo site_url()."admin/events/add_event" ?>",
        type:"POST",
        data:formdata,
        contentType:false,
        processData:false,
