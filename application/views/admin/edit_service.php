    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center" >
                <div class="col-md-10" >
                    <form method="post" enctype="multipart/form-data" id="form_edit_service">
                        <?php
                            foreach ($edit_service as $value):
                        ?>
                        ...
                        <script>
                            $("#category").val("<?php echo $value->cat_id; ?>");
                        </script>
                        <?php
                            endforeach;
                        ?>
...
$("#form_edit_service").on('submit',function(e){
    e.preventDefault();
    var formdata=new FormData(this);
    $.ajax({
        url:"<?php echo site_url().'admin/service/do_edit_service' ?>",
        type:"POST",
        data:formdata,
        contentType:false,
        processData:false,
