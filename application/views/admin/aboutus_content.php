    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Add Aboutus Content</h4>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-8">
                    <form method="post" enctype="multipart/form-data" id="upload_aboutus">
...
<script>
$("#upload_aboutus").on('submit',function(event){
    
    event.preventDefault();
    var formdata=new FormData(this);
    $.ajax({
        url:'<?php echo site_url()."admin/about/add_aboutus_content" ?>',
        type:"POST",
        data:formdata,
        processData:false,
        contentType:false,
